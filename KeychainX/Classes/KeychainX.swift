...
open class KeychainX {
    /// Singleton
    public static let `default` = KeychainX()
    
    /// Attributes
    private (set) public var serviceName: String
    private (set) public var accessGroup: String?
    private static let defaultServiceName: String = {
        Bundle.main.bundleIdentifier ?? "SwiftKeychainX"
    }()
    
    /// Initializers
    
    /// Create an instance of `KeychainX` with a custom service name and optional access group.
    ///
    ...
    private convenience init() {
        self.init(serviceName: KeychainX.defaultServiceName)
    }
    ...
    /// Remove all keychain data added through the keychainX.
    ...
    /// Remove all keychain data even those not added by this keychainX
    ///
    /// - Warning: This may remove custom keychain items you did not add via the keychainX.
    ///
